document.addEventListener("DOMContentLoaded", function () {
    loadPage('systemsettings'); // Default page
});
...
function loadPage(page) {
    ...
    // Fjern tidligere lastet script hvis det finnes
    ...
    if (page === "systemsettings") {
        document.getElementById("content").innerHTML = "<h2>System Settings</h2>";
        document.getElementById("sidebar").innerHTML = `<ul><li onclick="loadSystemSettings()">SystemSettings</li></ul>`;

        // Dynamisk last systemsettings.js
        let script = document.createElement("script");
        script.src = "js/systemsettings.js";
        script.id = "dynamicScript"; // Gir scriptet en ID for enklere fjerning senere
        document.body.appendChild(script);
    } else {
        document.getElementById("content").innerHTML = `<h2>${page.charAt(0).toUpperCase() + page.slice(1)}</h2>`;
        document.getElementById("sidebar").innerHTML = `<ul><li>Option 1</li><li>Option 2</li></ul>`;
    }
}
