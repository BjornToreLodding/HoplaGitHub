...
// Registrer DbContextFactory som Scoped, slik at den ikke skaper konflikt
//builder.Services.AddScoped<IDbContextFactory<AppDbContext>, DbContextFactory<AppDbContext>>();

// Registrer DbContextFactory som Scoped, slik at det ikke skaper konflikt
...
// 1️⃣ Registrer AppDbContext som Scoped
builder.Services.AddDbContext<AppDbContext>(options =>
    options.UseNpgsql(connectionString));

// 2️⃣ Registrer DbContextFactory som Scoped (IKKE Singleton!)
builder.Services.AddDbContextFactory<AppDbContext>(options =>
    options.UseNpgsql(connectionString));

// 3️⃣ ✅ Riktig registrering av MediatR 11+
builder.Services.AddMediatR(Assembly.GetExecutingAssembly());

// 4️⃣ Registrer EntityService som Scoped
...
//17.03.2025 fjernet denne da det ligger en annen addMediateR et tidligere i koden.
