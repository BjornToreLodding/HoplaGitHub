...
public static class UserRelationMock 
{
    public static List<UserRelation> CreateUserRelationMock(List<User> existingUsers){
        ...
        {
            new UserRelation {
                FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780001"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780002"), Status = "FRIEND", //, CreatedAt = 
            },
            
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780001"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780003"), Status = "FRIEND" }, //, CreatedAt = 
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780001"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780004"), Status = "FRIEND" }, //, CreatedAt = 
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780001"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), Status = "FRIEND" },
            ...
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780002"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780003"), Status = "FRIEND" },
            ...
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780003"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780004"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780003"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780003"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780006"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780004"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780004"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780006"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780006"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780016"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780017"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780018"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780019"), Status = "FRIEND" },
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780005"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780020"), Status = "FRIEND" },
            ...
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780032"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780001"), Status = "FRIEND" },
            ...
            new UserRelation { FromUserId = Guid.Parse("12345678-0000-0000-0001-123456780032"), ToUserId = Guid.Parse("12345678-0000-0000-0001-123456780038"), Status = "FRIEND" },
