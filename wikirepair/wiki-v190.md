...
</pre>JSON-Response hvis bruker ikke har registrert name eller alias (f.eks akuratt bekreftet epostadressen.):
...
</pre>**For update, se lengere ned i dokumenter om registrering**
...
</pre>:outbox_tray: **Eksempel på respons uten query:**
...
</pre>:outbox_tray: **Eksempel på respons med query når bruker fra token er venner med userId fra query:**
...
</pre>:outbox_tray: **Eksempel på respons med query når bruker fra token ikke er venner med userId fra query:**
...
</pre>:outbox_tray: **Eksempel på respons med query når bruker fra token er blokkert av userId fra query:**

<pre>

`{ Tomt? skal vi vise noe i det hele tatt? }`

</pre>:pager: **Mulige statuskoder:**
...
</pre>:outbox_tray: **Eksempel på respons med queryene pageNumber=7 og pageSize=2**
...
</pre>OBS!! Authorization er aktivert, så dette må også med i Requesten.
...
</pre>Mottar epost med beskjed om å bekrefte epostadressen ved å trykke på en lenke..
...
</pre>Åpne epost og trykk på aktiveringslenke. I noen tilfeller har det tatt opptil 30 minutter før eposten har kommet frem.
...
</pre>* Vise alle løyper som brukere har lagt inn i appen. Flest stjerner øverst (hvis likt antall stjerner, nyeste av de øverst. Runde opp så det er f.eks 5 istede for 4.6 så sortere). Løypene må være offentlig eller fra venner
...
</pre>:alien: :apple: **Løyper -\> Hjerte ikon**
...
</pre>:alien: :apple: **Løyper -\> Stjerne ikon (bytte til 2 personers ikon)**
...
</pre>**Trinn 2:** Bekreft epostadressen
...
</pre>**Når man trykker bekreft, sendes man hit:**
...
</pre>**Trinn 3:** Logg inn for videre registrering **logger inn med endpoint for login:**
...
</pre>**eksempel på response**

<pre>

`Brukerinformasjon oppdatert.`

</pre>## **:green_book: :alien: :apple: POST /users/reset-password-request**
...
</pre>UserId registreres automatisk fra Token
...
</pre>## **:green_book: :alien: :apple: PATCH /users/delete**
...
</pre>**BRUKEREN BLIR IKKE SLETTET!! men deaktivert. Dette for å bevare databaseintegritet da brukeren kan ha opprettet løper som andre brukere kan ha laget turer med osv.**
</td>
</tr>
<tr>
<td>
...
</pre>Annet: Her kan man sjekke og legge til filtere (ikke passordbeskyttet, men mulig man må logge inn):
...
</pre>\*\*Avrunding? på Distanse kan evt frontend gjøre :-) \*\*
...
</pre>Denne lager ny stall i Stables OG bruker som lager stallen blir satt som admin i StableUsers
</td>
</tr>
<tr>
<td>
...
</pre>Videre må man hente meldinger med neste endpoint
...
</pre>Oversikt over hva som brukes i hvilken situasjon
...
`https://hopla.onrender.com/trails/updates`
...
</pre>**Denne lager ny rating. Hvis brukeren har ratet tidligere, så oppdateres denne ratingen.**
